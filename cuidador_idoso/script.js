document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mostrar/esconder seção de sinais vitais baseado no tipo de evento
    tipoEventoSelect.addEventListener('change', function() {
        if (this.value === '🏥 Sinais Vitais') {
            ...
            // Limpar campos de sinais vitais quando não selecionado
    ...
    btnSalvarEvento.addEventListener('click', function() {
        ...
        if (modoEdicao && eventoEmEdicao) {
            ...
            atualizarEvento(eventoEmEdicao, horariosSelecionados[0], tipo, descricao, sinaisVitais);
            ...
            horariosSelecionados.forEach(hora => {
                adicionarEvento(periodo, hora, tipo, descricao, sinaisVitais);
            });
    ...
    function abrirModalEvento(periodo) {
        ...
        // Esconder seção de sinais vitais
        sinaisVitaisSection.style.display = 'none';
    ...
    function adicionarEvento(periodo, hora, tipo, descricao, sinaisVitais = null) {
    ...
    function atualizarEvento(eventoCard, hora, tipo, descricao, sinaisVitais = null) {
        const tipoIcone = getIconeParaTipo(tipo);
        const tipoNome = getTipoNome(tipo);
